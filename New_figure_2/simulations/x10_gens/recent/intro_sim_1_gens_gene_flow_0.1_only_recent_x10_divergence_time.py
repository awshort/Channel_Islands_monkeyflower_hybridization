...
demography.add_symmetric_migration_rate_change(time=taxa["cal_lon"][1] / 2, rate=0.1, populations=["island_lon", "par"])
demography.add_symmetric_migration_rate_change(time=taxa["cal_lon"][1] / 2 + 1, rate=0, populations=["island_lon", "par"])
...
with open("sim_1_gens_gene_flow_0.1_only_recent_x10_divergence_time.vcf", "w") as f:
